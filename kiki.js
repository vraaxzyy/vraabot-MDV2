...
break
	    ...
	    break
            case 'listpc': {
             ...
             break 
             case 'sc': case 'script':
             m.reply(`github.com/DikaArdnt/Hisoka-morou `)
break
...
case 'donasi': case 'buypremium': case 'donate': {
                kiki.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/83cc86ce7b8a1bfea65ea.jpg' }, caption: `*Hai Kak ${m.pushName}*seberapa donasi kamu akan saya tanggung terimakasih 🙏🏻` }) 
    }
	break
    case 'grupowner':
